...
This module provides the PModel class, which wraps the pyrealm P-Model
...
class PModel:
    """P-Model component for calculating photosynthesis and productivity.

    The P-Model is a biochemical model of photosynthesis that calculates
    gross primary productivity (GPP) based on environmental drivers including
    temperature, vapor pressure deficit, CO2 concentration, atmospheric pressure,
    and light availability (fAPAR, PPFD).
    ...
    def __call__(
        ...
        return (pmodel.gpp, pmodel.lue, pmodel.iwue)
...
def pmodel(
    ...
    return PModel(
        ...
        fapar=fapar,
        ppfd_umol_m2_s1=ppfd_umol_m2_s1,
